...
export default function OpenRingMechanical() {
  ...
  const buildMarkdown = () => [
    ...
    `---`,``,`_Generated by The Open Ring (self-hosted) — openprotocol_`,
  ].join("\n");
  ...
  const signalReady   = sf.signalStatus&&sf.channelStatus&&sf.groundStatus&&sf.reachStatus;
    ...
    <>
      ...
      <div className="or-root">
        ...
        <div className="or-header">
          <div className="or-eyebrow">OPENPROTOCOL — SELF-HOSTED CYCLE</div>
          <h1 className="or-title">The Open Ring</h1>
          <p className="or-sub">You provide the intelligence. The framework applies the logic. No API required.</p>
